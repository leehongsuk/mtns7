    ...
    */
    ...
    if  ($Action=="98")   // 예상 스코어보고...
    {
        ...
        if  ($Content)
        {
            ...
            $sQuery = "Select * From bas_filmtitle   ".
                      " Where Code   = '".$Film2."'  ".
                      "   And Finish = 'N'           " ;  //fwrite($fd, __LINE__.":".$sQuery."\r\n");
            $QryFilmtitle = mysql_query($sQuery,$connect) ;
            if  ($ArrFilmtitle = mysql_fetch_array($QryFilmtitle))
            {
				...
				$GikumRate = 1.03 ;
				$sQuery = "SELECT IF( '".$SingoDate."' >=  '20160523', GikumRate,  1.03 ) GikumRate ".
						  "  FROM bas_theather                                                     ".
                ...
                $sQuery = "Select * From bas_showroom        ".
                          " Where Theather = '".$Theather."' ".
                          "   And Room     = '".$Room2."'    " ;  //fwrite($fd, __LINE__.":".$sQuery."\r\n");
                $QryRoom = mysql_query($sQuery,$connect) ;
                if  ($ArrRoom = mysql_fetch_array($QryRoom))
                {
                    ...
                    if  ($Sparate == "00") //  지정일 신고자료
                    {
                        $sQuery = "Delete From ".$sSingoName."           ".
                                  ...
                                  "   And Open       = '".$Open."'       ".
                                  "   And Film       = '".$Film."'       ".
                                  "   And ShowDgree  = '".$Degree2."'    " ;    //fwrite($fd, __LINE__.":".$sQuery."\r\n");
                    ...
                    foreach ($Items1 as $Item1)
                    {
                        ...
                        if   ($Sparate == "00")  //  지정일 신고자료
                        {
                            if  ($UnitPrice >= $MinPrice) // 최소 금액.
                            {
                                ...
                                $sQuery = "Select Time From ".$sDgrpName."       ".
                                          ...
                                          "   And Theather = '".$Theather."'     ".
                                          "   And Room     = '".$Room2."'        ".
                                          "   And Degree   = '".$Degree2."'      " ;    //fwrite($fd, __LINE__.":".$sQuery."\r\n");
                                ...
                                $sQuery = "Delete From wrk_silmoosiljuk       ".
                                          ...
                                          "   And Degree   = '".$Degree2."'   ".
                                          "   And Open     = '".$Open."'      ".
                                          "   And Film     = '".$Film."'      " ;    //fwrite($fd, __LINE__.":".$sQuery."\r\n");
                                mysql_query($sQuery,$connect) ;
                        ...
                        $sQuery = "Select Sum(NumPersons) As SumNumPersons,   ".
                                  ...
                                  "   And Open      = '".$Open."'             ".
                                  "   And Film      = '".$Film."'             ".
                                  "   And UnitPrice = '".$UnitPrice."'        " ;     //fwrite($fd, __LINE__.":".$sQuery."\r\n");
                    ...
                    if  (($Degree2!="01") && ($Degree == $MaxDegree))  // 수신받은 회차가 마지막회차인 경우..
                    {
                        $sQuery = "Select UnitPrice,                        ".
                                  ...
                                  "   And NumPersons > 0                    ".
                                  " Group By UnitPrice                      ".
                                  " Order By UnitPrice Desc                 " ;   //fwrite($fd, __LINE__.":".$sQuery."\r\n");
                        ...
                        if  ($OutPut <> "")
                        {
                             echo "AT\$LGTSNDSM=".$PhonNo.",01024690081,4098,\"" .  $Room . " " . $OutPut . "계" . $TotNumPersons . "\"\r\n" ;
                        }
                    }
                    ...
                    if  ($Degree2=="01") // 1회차인 경우
                    {
                        $sQuery = "Select Count(*) As CntDegreepriv      ".
                                  ...
                                  "   And Theather = '".$Theather."'     ".
                                  "   And Room     = '".$Room2."'        ".
                                  " Order By Degree                      " ;   //fwrite($fd, __LINE__.":".$sQuery."\r\n");
                        ...
                        while ($ArrDegreeTime = mysql_fetch_array($QryDegreeTime))
                        {
                             ...
                             if  ($nDegree != 99)
                             {
                                 $TimeTable .= ($nDegree.":".$ArrDegreeTime["Time"]) ;
                             }
                             else
                             {
                                 $TimeTable .= ("심".$ArrDegreeTime["Time"]) ;
                             }

                             $OutPut = $OutPut . ( substr($ArrSingo["UnitPrice"],0,2) . "-" . $ArrSingo["sumNumPersons"] . " " ) ;
                        }
                        echo "AT\$LGTSNDSM=".$PhonNo.",01024690081,4098,\"". $Film." ".$Room2." ".$TimeTable ."\"\r\n" ;
                    }

                    // 신고한 회차에 시간표가 있는지를 확인한다.
                    if  ($Sparate == "00") //
                    {
                        $sQuery = "Select Count(*) As CntDegree          ".
                                  "  From ".$sDgrpName."                 ".
                                  " Where WorkDate = '".$SingoDate."'    ".
                                  "   And Open     = '".$Open."'         ".
                                  "   And Film     = '".$Film."'         ".
                    ...
                    $QryCntDegree = mysql_query($sQuery,$connect) ;
                    if  ($ArrCntDegree = mysql_fetch_array($QryCntDegree))
                    {
                        if  ($ArrCntDegree["CntDegree"] == 0) // 등록되지 않은 시간표의 회차로 신고한 경우
                        {
                            echo "AT\$LGTSNDSM=".$PhonNo.",01024690081,4098,\"시간표가 등록되지 않는 회차(".$Degree2.")입니다. 시간표를 다시 입력해주세요.\"\r\n" ;
                        }
                    }
                    ...
                    if  ($Sparate == "00") //
                    {
                        $sQuery = "Select Count(*) As CntDegree          ".
                                  ...
                                  "   And Theather = '".$Theather."'     ".
                                  "   And Room     = '".$Room2."'        ".
                                  "   And Degree   < '".$Degree."'       " ;   //fwrite($fd, __LINE__.":".$sQuery."\r\n");
                    }
                    if  ($Sparate == "22") //  이전날 신고자료
                    {
                        $sQuery = "Select Count(*) As CntDegree          ".
                    ...
                    if  ($ArrCntDegree = mysql_fetch_array($QryCntDegree))
                    {
                        if  ($ArrCntDegree["CntDegree"] > 0) // 첫회면 해당사항이 없다.
                        {
                            $ErrNsg = "" ;
                            ...
                            while ($ArrDegree = mysql_fetch_array($QryDegree))
                            {
                                $_Degree = $ArrDegree["Degree"] ; // 최근 이전 회차
                                ...
                                if  ($Sparate == "00") //
                                {
                                    $sQuery = "Select Count(*) As CntSingo          ".
                                              ...
                                              "   And Open      = '".$Open."'       ".
                                              "   And Film      = '".$Film."'       ".
                                              "   And ShowDgree = '".$_Degree."'    " ;  //fwrite($fd, __LINE__.":".$sQuery."\r\n");
                                }
                                if  ($Sparate == "22") //  이전날 신고자료
                                {
                                    $sQuery = "Select Count(*) As CntSingo          ".
                                ...
                                if  ($ArrCntSingo = mysql_fetch_array($QryCntSingo))
                                {
                                    ...
                                    if  ($CntSingo==0) // 회차에 해당하는 신고자료가 없으면..
                                    {
                                        if  ($ErrNsg != "")
                                        {
                                            $ErrNsg .= "," ;
                            ...
                            if  ($ErrNsg != "")
                            {
                                echo "AT\$LGTSNDSM=".$PhonNo.",01024690081,4098,\"".$Room."관 ".$ErrNsg."회가 입력되지 않았습니다. 재전송바랍니다.\"\r\n" ;
                            }
                        }
                    }
                }
    ...
    if  ($Action=="5555")
    {
        ...
        if  ($ArrFilmtitle = mysql_fetch_array($QryFilmtitle))
        {
            ...
            if  ($OutPut <> "")
            {
                 echo "AT\$LGTSNDSM=".$PhonNo.",01024690081,4098,\"" .  $Theather . " " . $Room . " " . $OutPut . "계" . $TotNumPersons . "\"\r\n" ;
            }
    ...
    if  ($Action=="5200")
    {
        ...
        if  ($ArrFilmtitle = mysql_fetch_array($QryFilmtitle))
        {
            ...
            while ($ArrSingo = mysql_fetch_array($QrySingo))
            {
                 ...
                 $OutPut = $OutPut . ( $ArrSingo["ShowDgree"] . ":" . $ArrSingo["sumNumPersons"] . " " ) ;
            }
    ...
    if  ($Action=="5300")
    {
        ...
        if  ($ArrFilmtitle = mysql_fetch_array($QryFilmtitle))
        {
            ...
            if  ($OutPut <> "")
            {
                 echo "AT\$LGTSNDSM=".$PhonNo.",01024690081,4098,\"" .  $Theather . " "  . $OutPut . "계" . $TotNumPersons . "\"" ;
            }
