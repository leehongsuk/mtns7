   ...
   <table cellpadding=0 cellspacing=0 border=1 bordercolor="#C0B0A0">
      ...
      <tr>
           ...
           ?>
           <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=number_format($SumSeatSeat)?>&nbsp;</td> <?
           ...
           for  ($i=1; $i<=11; $i++)
           {
                ...
                {
                ?>
                <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispData?>&nbsp;</td>
                <?
                }

           }
           ?>
           <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=number_format($nTotNumPersons)?>&nbsp;</td>
           <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=number_format($nTotTotAmount)?>&nbsp;</td>
      </tr>
      <!----------------------------------------------------------------------------------------------------------->
      <tr>
           <td class=textarea bgcolor=<?=$ColorC?> class=tbltitle align=center>
           ...
           ?>
           <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=number_format($SumSeatRate,2)?>%&nbsp;</td>
           ...
           for ($i = 1 ; $i <= 11 ; $i++)
           {
               if  ($i!=10)  // 예상인터네셔널
               {
                   ...
                   ?>
                   <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=number_format($ByDegreeRate,2)?>%&nbsp;</td>
                   <?
               }
           }
           ?>
