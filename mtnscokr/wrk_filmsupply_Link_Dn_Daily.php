   ...
   else
   {
       ...
       if  ($ZoneCode=="9999") // "전체"
       {
           ...
           if  ($TimJang==false) // 이부장..
           {
              ...
              if  ($WorkGubun == 33)
              {
                  $AddedCont .= " And singo.Silmooja = '555555' " ; ;
              }
              if  ($WorkGubun == 34) // 씨너스
              {
              ...
              $sQuery1 = "Select Singo.RoomOrder,                         ".
                        "       Singo.Theather,                          ".
                        "       Singo.Room,                              ".
                        "       Singo.Open,                              ".
                        "       Singo.Film,                              ".
              ...
              $sQuery2 = "Select Singo.RoomOrder,                         ".
                        "       Singo.Theather,                          ".
                        "       Singo.Room,                              ".
                        "       Singo.Open,                              ".
                        "       Singo.Film,                              ".
           ...
           $sQuery3 = "Select Singo.RoomOrder,                         ".
                     "       Singo.Theather,                          ".
                     "       Singo.Room,                              ".
                     "       Singo.Open,                              ".
                     "       Singo.Film,                              ".
           ...
           if  ($AddedCont != "") // 경강지역에 해당하는 자료가 있는경우..
           {
               ...
               $sQuery4 = "Select Singo.RoomOrder,                         ".
                         "       Singo.Theather,                          ".
                         "       Singo.Room,                              ".
                         "       Singo.Open,                              ".
                         "       Singo.Film,                              ".
           ...
           if  ($AddedCont != "") // 충청지역에 해당하는 자료가 있는경우..
           {
               ...
               $sQuery5 = "Select Singo.RoomOrder,                         ".
                         "       Singo.Theather,                          ".
                         "       Singo.Room,                              ".
                         "       Singo.Open,                              ".
                         "       Singo.Film,                              ".
           ...
           if  ($AddedCont != "") // 경남지역에 해당하는 자료가 있는경우..
           {
               ...
               $sQuery6 = "Select Singo.RoomOrder,                         ".
                         "       Singo.Theather,                          ".
                         "       Singo.Room,                              ".
                         "       Singo.Open,                              ".
                         "       Singo.Film,                              ".
           ...
           if  ($AddedCont != "") // 경강지역에 해당하는 자료가 있는경우..
           {
               ...
               $sQuery7 = "Select Singo.RoomOrder,                         ".
                         "       Singo.Theather,                          ".
                         "       Singo.Room,                              ".
                         "       Singo.Open,                              ".
                         "       Singo.Film,                              ".
           ...
           if  ($AddedCont != "") // 경강지역에 해당하는 자료가 있는경우..
           {
               ...
               $sQuery8 = "Select Singo.RoomOrder,                         ".
                         "       Singo.Theather,                          ".
                         "       Singo.Room,                              ".
                         "       Singo.Open,                              ".
                         "       Singo.Film,                              ".
           ...
           $sQuery9 = "Select Singo.RoomOrder,                         ".
                     "       Singo.Theather,                          ".
                     "       Singo.Room,                              ".
                     "       Singo.Open,                              ".
                     "       Singo.Film,                              ".
...
$sQuery = "" ;
if  ($sQuery1!="") { if  ($sQuery != "") $sQuery .= " Union " ;  $sQuery .= "(".$sQuery1.")" ;  }
if  ($sQuery2!="") { if  ($sQuery != "") $sQuery .= " Union " ;  $sQuery .= "(".$sQuery2.")" ;  }
if  ($sQuery3!="") { if  ($sQuery != "") $sQuery .= " Union " ;  $sQuery .= "(".$sQuery3.")" ;  }
if  ($sQuery4!="") { if  ($sQuery != "") $sQuery .= " Union " ;  $sQuery .= "(".$sQuery4.")" ;  }
if  ($sQuery5!="") { if  ($sQuery != "") $sQuery .= " Union " ;  $sQuery .= "(".$sQuery5.")" ;  }
if  ($sQuery6!="") { if  ($sQuery != "") $sQuery .= " Union " ;  $sQuery .= "(".$sQuery6.")" ;  }
if  ($sQuery7!="") { if  ($sQuery != "") $sQuery .= " Union " ;  $sQuery .= "(".$sQuery7.")" ;  }
if  ($sQuery8!="") { if  ($sQuery != "") $sQuery .= " Union " ;  $sQuery .= "(".$sQuery8.")"  ; }
if  ($sQuery9!="") { if  ($sQuery != "") $sQuery .= " Union " ;  $sQuery .= "(".$sQuery9.")" ;  }
