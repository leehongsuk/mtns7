...
?>
       ...
       <script type="text/javascript">
        <!--
            ...
            $("input.FilmtitleUpdate").click(function()
            {
                ...
                var options = {
                    ...
                    _primusName: $('input.FilmtitleprimusName').eq(index).attr( "value" )
                } ;

                $.post("./wrk_filmsupply_Link_DnExcel_Primus_UD.php", options, function(data)
                {
                    //alert(data) ;
                });
            });
            ...
            $("input.FilmtitleDelete").click(function()
            {
                ...
                $('input.FilmtitleprimusName').eq(index).val( "" );
            ...
            $("input.TheatherUpdate").click(function()
            {
                ...
                var options = {
                    ...
                    _primusName: $('input.TheatherprimusName').eq(index).attr( "value" )
                } ;
            ...
            $("input.TheatherDelete").click(function()
            {
                ...
                $('input.TheatherprimusName').eq(index).val( "" );
        ...
        <tr>
             <td>MTNS</td><td>PRIMUS</td><td colspan="2">&nbsp;</td>
        </tr>
        <?
        $i = 0 ;
        ...
        while ($ArrFilmtitle = mysql_fetch_array($QryFilmtitle))
        {
             ...
             {
                  $primusName = $ArrXlsFilmtitle["primusName"]  ;
             }
             ?>
             <tr>
                 <td><?=$mtnsName?></td>
                 <td><input class="FilmtitleprimusName" type="text" size="50" name="" value="<?=$primusName?>"></td>
        ...
        while ($ArrTheather = mysql_fetch_array($QryTheather))
        {
            ...
            {
                $primusName = $ArrXlsTheather["primusName"]  ;
            }
            ?>
            <tr>
                <td><?=$mtnsName?></td>
                <td><input class="TheatherprimusName" type="text" size="50" name="" value="<?=$primusName?>"></td>
