...
$WorkDate = $SingoDate ;               // 파일일자가 아닌 셀 값을 일자로 한다.
...
function ConvertDgree2($tempDgree)
{
    ...
    if  ($tempDgree=="13회")  $Dgree2 =  "13" ;
    if  ($tempDgree=="14회")  $Dgree2 =  "14" ;
    if  ($tempDgree=="15회")  $Dgree2 =  "15" ;
    if  ($tempDgree=="16회")  $Dgree2 =  "16" ;
    if  ($tempDgree=="17회")  $Dgree2 =  "17" ;
    if  ($tempDgree=="18회")  $Dgree2 =  "18" ;
    if  ($tempDgree=="19회")  $Dgree2 =  "19" ;
...
function ConvertRoom2($tempRoom)
{
    ...
    if  ($tempRoom=="13관")  $Room2 =  "13" ;
    if  ($tempRoom=="14관")  $Room2 =  "14" ;
    if  ($tempRoom=="15관")  $Room2 =  "15" ;
    if  ($tempRoom=="16관")  $Room2 =  "16" ;
    if  ($tempRoom=="17관")  $Room2 =  "17" ;
    if  ($tempRoom=="18관")  $Room2 =  "18" ;
    if  ($tempRoom=="19관")  $Room2 =  "19" ;
    if  ($tempRoom=="20관")  $Room2 =  "20" ;
    if  ($tempRoom=="21관")  $Room2 =  "21" ;
    if  ($tempRoom=="22관")  $Room2 =  "22" ;
    if  ($tempRoom=="23관")  $Room2 =  "23" ;
    if  ($tempRoom=="24관")  $Room2 =  "24" ;
    if  ($tempRoom=="25관")  $Room2 =  "25" ;
    ...
    ?>
        ...
        for ($i = 2; $i <= $data->sheets[0]['numRows']; $i++)
        {
            ...
            for ($j = 1; $j <= $data->sheets[0]['numCols']; $j++)
            {
                ...
                if  ($data->sheets[0]['cells'][$i][3] == "영화별 소계")
                {
                    $tdcolor = "gray" ;
                    $StartLine = $i + 1 ;
                }
                ...
                else
                {
                            ...
                            if  ($ArrFilmtitle = mysql_fetch_array($QryFilmtitle))
                            {
                                ...
                                if  ($ArrXlsTheather = mysql_fetch_array($QryXlsTheather))
                                {
                                    ...
                                    if  ($ArrTheather = mysql_fetch_array($QryTheather))
                                    {
                                        ...
                                        $Room2     = ConvertRoom2($data->sheets[0]['cells'][$i][4])  ;  // 상영관
                    ...
                    else
                    {
                       if  (($j==6) && ($cellvalue == "상영회차별 소계"))
                       {
                           ...
                           {
                                $Room2  = ConvertRoom2($data->sheets[0]['cells'][$k][4])  ;  // 상영관
                                $Dgree2 = ConvertDgree2($data->sheets[0]['cells'][$k][5]) ;  // 회차
                       ...
                       {
                           if  (
                               ($data->sheets[0]['cells'][$i][3] != "영화별 소계") &&
                ...
                )
            {
                ...
                $Room2  = ConvertRoom2($data->sheets[0]['cells'][$i][4])  ;   // 상영관
                $Dgree2 = ConvertDgree2($data->sheets[0]['cells'][$i][5]) ;   // 회차
