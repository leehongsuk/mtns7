...
<?
    ...
    if  (session_is_registered("logged_UserId"))
    {
        ...
        else
        {
            ...
            $str_prev_page = "<A href=\"#\" onclick='move_prev(write.checkboxs)'>[ 이전 ]</A>";
        }
        ...
        else
        {
            ...
            $str_next_page = "<A href=\"#\" onclick='move_next(write.checkboxs)'>[ 다음 ]</A>";
        }  
...
<html>
  ...
  <center>
   ...
   <table border="1" cellpadding="2" cellspacing="0" bordercolor='#C0B0A0'>
     <tr>
          <td align=center bgcolor=<?=$ColorA?>>선택</td>
          ...
          <td align=left  bgcolor=<?=$ColorA?>>소속</td>
