    ...
    <table cellpadding=0 cellspacing=0 border=1 bordercolor='#C0B0A0'>
       ...
       <tr height=25>
             ...
             {
             ?>
             <td class=textarea bgcolor=<?=$ColorA?> align=center>기금적용<?if  (!$ToExel) { ?><br><? } else { echo "\n" ; }?>당일금액</td>
             <td class=textarea bgcolor=<?=$ColorA?> align=center>누계금액</td>
             <?
             }
             else
             {
...
//eq($sQuery);
            ...
            ?>
            <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispItm1?>&nbsp;</td>
            ...
            ?>
            <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispItm2?>&nbsp;</td>
            ...
            ?>
            <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispItm3?>&nbsp;</td>
            ...
            {
            ?>
            <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispItm43?>&nbsp;</td>
            <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispItm5?>&nbsp;</td>
            <?
            }
            else
            {
            ...
            <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispItm5?>&nbsp;</td>
            <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispItm43?>&nbsp;</td>
            <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispItm53?>&nbsp;</td>
            <?
            }
            ?>
       </tr>
...
//eq($sQuery);
       ...
       if  ($zone_data = mysql_fetch_array($qryzone))
       {
            ...
            <tr height=20>
                ...
                ?>
                <td class=textarea bgcolor=<?=$ColorC?> align=right>&nbsp;<?=$dispAgoRate?>%&nbsp;</td>
                <?
       ...
       <tr height=20>
            ...
            ?>
            <td class=textarea bgcolor=<?=$ColorD?> align=right>&nbsp;<?=$dispItm1?>&nbsp;</td>
            ...
            ?>
            <td class=textarea bgcolor=<?=$ColorD?> align=right>&nbsp;<?=$dispItm2?>&nbsp;</td>
            ...
            {
            ?>
            <td class=textarea bgcolor=<?=$ColorD?> align=right>&nbsp;<?=$dispItm43?>&nbsp;</td>
            <td class=textarea bgcolor=<?=$ColorD?> align=right>&nbsp;<?=$dispItm5?>&nbsp;</td>
            <?
            }
            else
            {
            ...
            <td class=textarea bgcolor=<?=$ColorD?> align=right>&nbsp;<?=$dispItm5?>&nbsp;</td>
            <td class=textarea bgcolor=<?=$ColorD?> align=right>&nbsp;<?=$dispItm43?>&nbsp;</td>
            <td class=textarea bgcolor=<?=$ColorD?> align=right>&nbsp;<?=$dispItm53?>&nbsp;</td>
            <?
            }
            ?>
       </tr>
