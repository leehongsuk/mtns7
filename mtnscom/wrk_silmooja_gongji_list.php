      ...
      while ($ArrFilmgongji = mysql_fetch_array($QryFilmgongji))
      {
            ...
            else
            {
                ...
                <tr>
                     ...
                     <td><a href="wrk_silmooja_gongji_detail.php?WorkDate=<?=$WorkDate?>&Film=<?=$ArrFilmgongji["Film"]?>&Silmooja=<?=$ArrFilmgongji["Silmooja"]?>&GongjiNo=<?=$ArrFilmgongji["GongjiNo"]?>&BackAddr=wrk_silmooja.php&BackAddr2=wrk_silmooja_gongji_list.php"><?=$ArrFilmgongji["Title"]?></a></td>
                </tr>
                <?
            }
      }
