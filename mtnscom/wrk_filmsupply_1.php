    ...
    else
    {
        ...
        <TR>
          ...
          <TD align=center width=100% colspan=7 class=title>
            <a href=$PHP_SELF?year=$prevyear&month=$prevmonth>
            <span class=smalltext>◀</span>
            </a>

            $year 년 $month 월

            <a href=$PHP_SELF?year=$nextyear&month=$nextmonth>
            <span class=smalltext>▶</span>
            </a>
          </TD>
        ...
        while ($date <= $maxdate)
        {
          ...
          echo "
               ...
               <a OnClick=\"location.href='wrk_filmsupply.php?WorkDate=".date('Ymd', mktime(0, 0, 0, $month, $date, $year))."'\">".$date."</a>
               </p></TD> \n";
