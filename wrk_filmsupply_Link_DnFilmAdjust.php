            ...
            <input type="hidden" name="hidType">
                ...
                <table border="0" cellspacing="1" bgcolor="#3399CC"  align="center">
                   ...
                   <tr bgcolor="#dfdfdf">
                           ...
                           <td align="center">신고테이블</td>
                           <td align="center">bas_silmoojatheather</td>
                   </tr>                   
                   <tr bgcolor="#dfdfdf">
                           <td colspan=2 align="center">종영/Extention</td>
                           <!-- 이름 -->
                           <td align="center">신고누적정보</td>
                           <td align="center">bas_silmoojatheatherpriv</td>
                   </tr>
                   <tr bgcolor="#dfdfdf">
                           <td rowspan=5 colspan=2></td><!-- 코드,이름 -->
                           <td align="center">회차정보</td>
                           <td align="center">bas_degree</td>
                   </tr>
                   <tr bgcolor="#dfdfdf">
                           <!-- 코드,이름 -->
                           <td align="center">회차정보(일자별)</td>
                           <td align="center">bas_degreepriv</td>
                   </tr>
                   <tr bgcolor="#dfdfdf">
                           <!-- 코드,이름 -->
                           <td align="center">상영관순서정보</td>
                           <td align="center">&nbsp;</td>
                   </tr>
                   <tr bgcolor="#dfdfdf">
                           <!-- 코드,이름 -->
                           <td align="center">필름종류</td>
                           <td align="center">&nbsp;</td>
                   </tr>
                   <tr bgcolor="#dfdfdf">
                           <!-- 코드,이름 -->
                           <td align="center">필름종류(일자별)</td>
                           <td align="center">&nbsp;</td>
                   </tr>
                    ...
                    */                    
                    ...
                    while ($ArrFilmtitle = mysql_fetch_array($QryFilmtitle))
                    {
                        ...
                        <tr bgcolor=<?=$bgcolor?>>
                            ...
                            <td><?=$SingoName?>  <?=PrnState("ORG",GetCount($SingoName,$connect1,$db1))?>:<?=PrnState("BAK",GetCount($SingoName,$connect2,$db2))?></td>
                            <? $tablename = "bas_silmoojatheather" ; ?>
                            <td><?=$tablename?>  <?=PrnState("ORG",GetRowCount($tablename,"Open","Film",$Open,$Film,$connect1,$db1))?>:<?=PrnState("BAK",GetRowCount($tablename,"Open","Film",$Open,$Film,$connect2,$db2))?></td>
                        </tr>
                        <tr bgcolor=<?=$bgcolor?>>
                            <td colspan=2 align="center">종영:<?=$Finish?> / Ext:<?=$Extension?></td>
                            <!-- 이름 -->
                            <td><?=$AccName?>  <?=PrnState("ORG",GetCount($AccName,$connect1,$db1))?>:<?=PrnState("BAK",GetCount($AccName,$connect2,$db2))?></td>
                        ...
                        <tr bgcolor=<?=$bgcolor?>>
                            ...
                            <td><?=$DgrName?>  <?=PrnState("ORG",GetCount($DgrName,$connect1,$db1))?>:<?=PrnState("BAK",GetCount($DgrName,$connect2,$db2))?></td>                           
                        ...
                        <tr bgcolor=<?=$bgcolor?>>
                            ...
                            <td><?=$DgrpName?>  <?=PrnState("ORG",GetCount($DgrpName,$connect1,$db1))?>:<?=PrnState("BAK",GetCount($DgrpName,$connect2,$db2))?></td>                           
                            <? $tablename = "bas_degreepriv" ; ?>
                            <td><?=$tablename?>  <?=PrnState("ORG",GetRowCount($tablename,"Open","Film",$Open,$Film,$connect1,$db1))?>:<?=PrnState("BAK",GetRowCount($tablename,"Open","Film",$Open,$Film,$connect2,$db2))?></td>
                        </tr>
                        <tr bgcolor=<?=$bgcolor?>>
                            <!-- 코드,이름 -->
                            <td><?=$RoomOrder?>  <?=PrnState("ORG",GetCount($RoomOrder,$connect1,$db1))?>:<?=PrnState("BAK",GetCount($RoomOrder,$connect2,$db2))?></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr bgcolor=<?=$bgcolor?>>
                            <!-- 코드,이름 -->
                            <td><?=$FtName?>  <?=PrnState("ORG",GetCount($FtName,$connect1,$db1))?>:<?=PrnState("BAK",GetCount($FtName,$connect2,$db2))?></td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr bgcolor=<?=$bgcolor?>>
                            <!-- 코드,이름 -->
                            <td><?=$FtpName?>  <?=PrnState("ORG",GetCount($FtpName,$connect1,$db1))?>:<?=PrnState("BAK",GetCount($FtpName,$connect2,$db2))?></td>
                            <td>&nbsp;</td>
                         </tr>
                         <?
                    }
