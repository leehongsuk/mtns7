    ...
    else
    {
        ...
        <TR>
          ...
          <TD align=center width=100% colspan=7 class=title>
            <a href=$PHP_SELF?ShowRoom=".$ShowRoom."&year=$prevyear&month=$prevmonth>
            <span class=smalltext>◀</span>
            </a>

            $year 년 $month 월

            <a href=$PHP_SELF?ShowRoom=".$ShowRoom."&year=$nextyear&month=$nextmonth>
            <span class=smalltext>▶</span>
            </a>
          </TD>
        ...
        while ($date <= $maxdate)
        {
          ...
          echo "
               ...
               <a OnClick=\"location.href='wrk_silmooja_7.php?M2005=".$M2005."&ShowRoom=".$ShowRoom."&WorkDate=".date('Ymd', mktime(0, 0, 0, $month, $date, $year))."&BackAddr=wrk_silmooja.php'\">".$date."</a>
               </p></TD> \n";
